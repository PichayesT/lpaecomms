...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['id']) && isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['address']) && isset($_POST['phoneNumber']) && isset($_POST['userName']) && isset($_POST['password'])) {
        ...
        $queryUsername = "SELECT COUNT(*) AS count FROM lpa_users WHERE lpa_user_username = ? AND lpa_user_ID != ?";
...
<div class="container_1">
    ...
    <form id="UpdateUserForm">
        <input type="text" id="search-input" name="firstName" placeholder="Client details..." required>
